...
//         if(promotionIDToReceiptIDs[drawingID].length < drawing.cohortSize*(1+cohort)) {
//             return false; 
//         }
//         else {
//             return true;
...
//         require(drawingEligibility(drawingID, cohort) && vrfRequestIDtoContext[drawingCohortsToVRFRequestID[drawingID][cohort]].drawingID ==0, "Ineligible");         
