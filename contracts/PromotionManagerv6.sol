...
//             SnowballReceipt storage snowballReceipt = SnowballReceipts[1 + i];//SnowballReceipts[initialTokenID + i];,$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
//         Snowball storage snowball = Snowballs[snowballID]; 
//         if ((snowball.endTime > block.timestamp && snowball.maxSlots > snowball.numParticipants) || snowball.returnedCustody) {
//             return 0; 
//         }
